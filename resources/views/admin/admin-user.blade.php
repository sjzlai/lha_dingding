...
@endsection
            ...
            <td>
              <div class="am-btn-toolbar">
                <div class="am-btn-group am-btn-group-xs">
                  ...
                  <button type="button" class="am-btn am-btn-default am-btn-xs" id="addJob"><span class="am-icon-copy"></span> 添加权限</button>
  ...
  <div class="am-fr">
      ...
      <li class="am-active">{{$users->links()}}</li>
...
<script>
  ...
  $("#addJob").click(function () {
     window.location.href="/admin/getJobList";
  })
</script>
