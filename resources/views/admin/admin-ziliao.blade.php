    ...
    <ul class="am-list admin-sidebar-list">
      ...
      <li class="admin-parent">
        ...
        <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
          <li><a href="admin-ziliao.blade.php" class="am-cf"><span class="am-icon-check"></span> 个人资料<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
          <li><a href="admin-help.html"><span class="am-icon-puzzle-piece"></span> 帮助页</a></li>
          <li><a href="admin-gallery.html"><span class="am-icon-th"></span> 相册页面<span class="am-badge am-badge-secondary am-margin-right am-fr">24</span></a></li>
          <li><a href="admin-log.blade.php"><span class="am-icon-calendar"></span> 系统日志</a></li>
          <li><a href="admin-404.blade.php"><span class="am-icon-bug"></span> 404</a></li>
        </ul>
      </li>
      <li><a href="admin-user.blade.php"><span class="am-icon-table"></span> 表格</a></li>
