      ...
      <div class="am-u-sm-12">
        <form class="am-form" >
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="table-check"><input type="checkbox" /></th><th class="table-id">ID</th><th class="table-author">用户名</th><th class="table-date">手机号</th><th class="table-date">创建时间</th><th class="table-date">修改时间</th><th class="table-set">操作</th>
              </tr>
          </thead>
          <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="am-btn-toolbar">
                <div class="am-btn-group am-btn-group-xs">
                  <a href="/admin/tbUserEditForm/{{$user->id}}" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
...
<script>
    ...
    $("#excelDown").click(function(){
        ...
        window.location.href="/admin/tbUserExcelDown";
